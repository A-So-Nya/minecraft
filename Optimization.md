...
|[Chunk-Pregenerator](https://www.curseforge.com/minecraft/mc-mods/chunkpregenerator)|Позволяет заранее генерировать чанки мира в определённом радиусе, чем спасает от лагов во время путешествий в неизученные места. А ещё имеет няшный интерфейс и даже умеет в ретроген.|
