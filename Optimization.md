...
| Мод | Описание |
|---|---|
|[OptiFine](https://optifine.net/downloads) (на 1.16.1 ещё нет)|Расширенные настройки графики, больше возможностей как к оптимизации, так и к красивостям.|
...
|[OptiFabric](https://www.curseforge.com/minecraft/mc-mods/optifabric) (на 1.16.1 ещё нет)|Требуется в дополнение к самому оптифайну для версий с фабриком.|
