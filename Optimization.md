...
|[Thaumic Fixer](https://www.curseforge.com/minecraft/mc-mods/thaumic-fixer)|Фиксит лаги во время сканирования таумометром в Thaumcraft. Требует FastCraft. **В комментариях пишут о большом количестве проблем и несовместимостей с этим модом, я решил всё-таки написать о нём тут, только потому что его рекоммендует Грег! Используйте на свой страх и риск.**|
